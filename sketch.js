...
replay = loadImage("replay.png.png");
...
function setup() {
  ...
  player = createSprite(100,375,40,40);
...
invisibleground = createSprite(200,410,800,15);
...
if(player.isTouching(cutterGroup)){
  score = score - 30;
}
...
function spawncutters(){
  if(World.frameCount % 120 == 0){
    var cutter = createSprite(random(400,700),370,40,40);
  ...
  function spawntrees(){
    if(World.frameCount % 30 == 0){
      var trees = createSprite(random(400,700),340,10,70);
